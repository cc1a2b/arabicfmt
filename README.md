# arabicfmt — Arabic Formatting for JavaScript & TypeScript

> Arabic number formatting · currency symbols · Hijri calendar · RTL/bidi text · number-to-words — zero dependencies, works in Node, browser and React Native.

[![npm version](https://img.shields.io/npm/v/arabicfmt.svg?style=flat-square&color=brightgreen)](https://www.npmjs.com/package/arabicfmt)
[![npm downloads](https://img.shields.io/npm/dm/arabicfmt.svg?style=flat-square)](https://www.npmjs.com/package/arabicfmt)
[![bundle size](https://img.shields.io/bundlephobia/minzip/arabicfmt?style=flat-square&label=gzipped)](https://bundlephobia.com/package/arabicfmt)
[![CI](https://img.shields.io/github/actions/workflow/status/cc1a2b/arabicfmt/ci.yml?branch=main&style=flat-square&label=CI)](https://github.com/cc1a2b/arabicfmt/actions/workflows/ci.yml)
[![TypeScript](https://img.shields.io/npm/types/arabicfmt.svg?style=flat-square)](https://www.npmjs.com/package/arabicfmt)
[![zero dependencies](https://img.shields.io/badge/dependencies-0-brightgreen?style=flat-square)](./package.json)
[![license MIT](https://img.shields.io/npm/l/arabicfmt?style=flat-square)](./LICENSE)

---

**arabicfmt** is the only JavaScript library that correctly handles the entire Arabic formatting stack — currency symbols, number precision, Hijri/Islamic calendar dates, RTL bidirectional text, and Arabic number-to-words — with zero runtime dependencies and full TypeScript types.

> **🕹 Live demo: [arabicfmt.vercel.app](https://arabicfmt.vercel.app)** — every feature below, interactive,
> rendered live in your browser by this library. ([source](./demo), one-click deployable)
...
The interactive playground in [`demo/`](./demo) runs the library live in the browser —
currency studio, تفقيط, Hijri converter, plurals, RTL fixes and more.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/cc1a2b/arabicfmt)

```sh
cd demo && npm install && npm run dev
```

The root [`vercel.json`](./vercel.json) makes the repo deploy on Vercel with zero
configuration — import the repo at [vercel.com/new](https://vercel.com/new) and hit Deploy.
